function ObjectData
(
    vertexCountIn,verticesIn,normalsIn,texcoordsIn
)
{
...
function fromObjStrToObjectData(objStr)
{
    ...
    return new ObjectData(alvResult.length/3,alvResult,alnResult,altResult);
}
