 function TextureRect(								//声明绘制用物体对象所属类
	...
	this.drawSelf=function(ms,texture,lodLevel)//绘制物体的方法
	{	
		...
		//获取纹理级别引用ID
        var lod=gl.getUniformLocation(this.program, "lodLevel");
        //将纹理级别送入渲染管线
        gl.uniform1f(lod,lodLevel);
