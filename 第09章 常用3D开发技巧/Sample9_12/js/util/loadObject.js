	...
	if(shaderProgArray[id])//如果指定着色器已加载完毕
	{
		...
		{//物体编号
			case 0://创建地图对象
                ...
                console.log(id+"masss");
			break;
	  
			case 1://创建天空盒对象
				masss1=new ObjObject(gl,objDataIn.vertices,objDataIn.normals,shaderProgArray[id]);
                console.log(id+"masss1");
			break;
		  
			case 2://创建矩形绘制对象
				masss2=new objObjectEdge(gl,objDataIn.vertices,objDataIn.normals,shaderProgArray[id]);
                console.log(id+"masss2");
			break;
		  
			case 3://创建水池对象
				masss3=new objObjectEdge(gl,objDataIn.vertices,objDataIn.normals,shaderProgArray[id]);
                console.log(id+"masss3");
			break;
