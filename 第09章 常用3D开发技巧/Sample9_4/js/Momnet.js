function Momnet(								//声明绘制用物体对象所属类
	...
	{	
		...
		gl.uniform1f(gl.getUniformLocation(this.program, "landStartY"), 0);
		gl.uniform1f(gl.getUniformLocation(this.program, "landYSpan"), 20);
		
		//设置纹理
		gl.uniform1i(gl.getUniformLocation(this.program, "sTextureGrass"), 0);//将白天纹理送入渲染管线 
		gl.uniform1i(gl.getUniformLocation(this.program, "sTextureRock"), 1);	 //将黑夜纹理送入渲染管线		  
