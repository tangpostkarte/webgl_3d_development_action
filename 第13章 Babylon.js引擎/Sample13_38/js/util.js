...
addBloomAndGUI=(scene,cameraArry)=>{
    ...
    addSlider("焦距", function(value) {
        pipeline.depthOfField.focusDistance = value;
    }, pipeline.depthOfField.focusDistance, 1, 50000, );   

    addSlider("步长", function(value) {
        pipeline.depthOfField.fStop = value;
    }, pipeline.depthOfField.fStop, 1.0, 10, );   
    
    addSlider("长焦", function(value) {
        pipeline.depthOfField.focalLength = value;
    }, pipeline.depthOfField.focalLength, 1.0, 300, );    
